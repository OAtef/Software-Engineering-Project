$(document).ready(function(){
    ...
    $.ajax({ 
        url: 'get_project_categories.php',
        type: 'POST',
        dataType: "JSON",
    ...
    $(document).on('click','#up-finishbtn',function(e){
        ...
        if(project_name == "" || budget == "" || num_of_phases == "" || current_phase == ""){
            ...
            // fadel heta bt3t members, team leaders and org

            $.ajax({
                url: 'update_project.php',
                data: {pro_info: arr, projectID: project[0]},
                type: 'POST',
                dataType: "JSON",
                success: function(data) {
                    console.log(data);
