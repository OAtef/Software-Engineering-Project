  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Reporting <sup>2</sup></div>
      </a>
...
alert("data");
  ...
  function changeButton() // no ';' here
  {
    ...
    if (elem.innerText == "ChartBar") {
      ...
      toChartBar();
    } else if (elem.innerText == "Normal View") {
      elem.innerText = "ChartBar";
      toNormalReport();
    }
  }
  ...
  function toNormalReport() {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        document.getElementById("cardbody").innerHTML = this.response
