...
class decorator10 extends invoiceDecorator
{
    protected $invoice;
    ...
    public function addinfo(){
        ...
        $get_data = array();
        $get_data['ref_id'] = $this->invoice->ref_id;
        ...
        $this->invoice->pdf->Image('../../../img/lifefromwater.png', 10, 110, 100, 35);


        $this->invoice->pdf->Line(155, 113, 195, 113);
